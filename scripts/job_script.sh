...
exp_dir=${ROOT}/data/experiments/mouse # this should be an arg to avoid repetition
rm -rf $exp_dir
mkdir $exp_dir
mpirun -v -machinefile $PBS_NODEFILE -np 4 --map-by ppr:1:node python ${ROOT}/scripts/analysis_pipe.py -m -p >> /home/brirry/logs/analysis.log 2>&1